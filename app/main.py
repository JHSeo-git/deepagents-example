...
from app.core.llm_monitor.llm_monitor_loader import get_llm_monitor
...
def internet_search(
    ...
    """Run a web search"""
    tavily_async_client = TavilyClient(api_key=settings.TAVILY_API_KEY)
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        callbacks = [llm_monitor.get_callback_handler()]
        metadata = {
            "langfuse_user_id": "system",
            "langfuse_session_id": thread_id,
        }

        async for stream_mode, event_data in agent.astream(
            input={
                "messages": [
                    {
                        "role": "user",
                        "content": "What is the langgraph?",
                    },
                ]
            },
            config={
                "run_name": "research_deep_agent",
